        ...
        .then( resp=>{
            ...
            if (resp.status && resp.status == 'ok') {
                ...
                resp.message.forEach( e => {
                    e["idproductline"] = e.idproductline.toString();
                    lstData.push(e)    
                });
...
function estructuraGrid(){
    gridOptions = {
        ...
        getRowId: (params) => {
            return params.data.idproductline;
        },
        onRowClicked: (event) => {
            dataSelected = event.data;
            idSelect = event.data.idproductline;
...
async function saveData(){
    ...
    let idproductline = parseInt($("#idproductline").val());
    ...
    let url = `saveProductoLineas&id=${idproductline}`;
...
$("#btmDelete").on("click", function(){
    hacerPregunta("Eliminar Producto", "eliminar", "deleteProductoLineas");
});

$("#btmReestablecer").on("click", function(){
    hacerPregunta("Recuperar un producto eliminado", "recuperar", "recuperarProductoLineas");
});
...
async function realizarAccion(ruta=""){
    let method = ruta == "deleteProductoLineas" ? "DELETE" : "POST";
