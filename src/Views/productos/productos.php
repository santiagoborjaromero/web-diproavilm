    ...
    <div class="col-12 col-md-11 align-items-center bg-white round-10">
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Descripcion <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
                        <input class="form-control" type="text" id="description"  placeholder="Descripcion">
                    </div>
                </div>
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Codigo <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
                        <input class="form-control" type="text" id="productcode"  placeholder="Codigo">
                    </div>
                </div>
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Codigo de Barras <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
                        <input class="form-control" type="text" id="barcode"  placeholder="Codigo de Barras">
                    </div>
                </div>
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Presentación <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
                ...
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Línea <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
                ...
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Categoría <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
                ...
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">PVP <sup class="text-danger" title="Requerido">*</sup></label>
                    <div class="col-12 col-md-8">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Costo</label>
                    <div class="col-12 col-md-8">
                        <input class="form-control" type="text" id="accountcost"  placeholder="0.0.00.00.00">
                    </div>
                </div>
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Ventas</label>
                    <div class="col-12 col-md-8">
                        <input class="form-control" type="text" id="accountsales"  placeholder="0.0.00.00.00">
                    </div>
                </div>
                <div class="row mb-2">
                    <label class="col-12 col-md-4 control-label text-end">Inventario</label>
                    <div class="col-12 col-md-8">
