            ...
            <div class="col-12 col-md-6">
                <div class="row mt-5 mb-5">
                    ...
                    <div class="col-12 col-md-8">
                        <input class="form-control" type="hidden" id="idproductcategory" value="">
                        <input class="form-control" type="text" id="description"  placeholder="Descripcion de la Categoria">
                    </div>
...
<script src="src/Views/categoria/categoria.js"></script>
