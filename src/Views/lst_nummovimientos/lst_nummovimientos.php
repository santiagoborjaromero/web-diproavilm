        ...
        <table class="tables mt-3">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <button action="Anio" id="Anio" class='buscar btn btn-light'></button>
                        <button action="T1" class='buscar btn btn-light'>Trimestre 1</button>
                        <button action="T2" class='buscar btn btn-light'>Trimestre 2</button>
                        <button action="T3" class='buscar btn btn-light'>Trimestre 3</button>
                        <button action="T4" class='buscar btn btn-light'>Trimestre 4</button>
                    ...
                    <td class="p-3" width="60%">
                        ...
                        KPI. Movimiento de productos<br>
                        Es el indicador de los movimientos que tiene un producto por un período determinado.
                    </td>
                </tr>
            </tbody>
        </table>
...
<script src="src/Views/lst_nummovimientos/lst_nummovimientos.js"></script>
